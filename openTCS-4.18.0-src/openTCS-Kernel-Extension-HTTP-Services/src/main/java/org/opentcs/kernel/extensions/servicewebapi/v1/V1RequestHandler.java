...
public class V1RequestHandler
  ...
  public void addRoutes(Service service) {
    ...
    /////////////////////modified by Henry
    service.post("/inBound/:NAME",this::handlePostInBound);
    service.post("/outBound/:NAME",this::handlePostOutBound);
    /////////////////////modified end
...
//////////////////////////////////////////////////////////////////////////modified by Henry
  private Object handlePostInBound(Request request, Response response)
      throws ObjectUnknownException,
             ObjectExistsException,
             IllegalArgumentException,
             IllegalStateException {
