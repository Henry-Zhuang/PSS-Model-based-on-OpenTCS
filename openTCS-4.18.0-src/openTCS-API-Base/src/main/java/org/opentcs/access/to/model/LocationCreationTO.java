...
public class LocationCreationTO
  ...
  /**
   * The Bins stored in this location.
   * modified by Henry.
   */
  @Nonnull
  ...
  public LocationCreationTO withName(@Nonnull String name) {
    return new LocationCreationTO(name, getModifiableProperties(), typeName, position, links, Bins);
  }
  ...
  public LocationCreationTO withTypeName(@Nonnull String typeName) {
    return new LocationCreationTO(getName(), getModifiableProperties(), typeName, position, links, Bins);
  }
 ...
 /////////////////////////////////////////////////////////////////////////////Modified by Henry {
   ...
   * @return The bin stack of this location.
   */
  @Nonnull
  ...
  /**
   * Creates a copy of this object with the location's bin stack.
   *
   * @param Bins The location's bin stack.
   * @return A copy of this object, differing in the given bin stack.
   */
  public LocationCreationTO withBins(@Nonnull List<Bin> Bins) {
    return new LocationCreationTO(getName(), getModifiableProperties(), typeName, position, links, Bins);
  }
 ...
 /////////////////////////////////////////////////////////////////////////////Modified end }
  ...
  public LocationCreationTO withProperties(@Nonnull Map<String, String> properties) {
    return new LocationCreationTO(getName(), properties, typeName, position, links, Bins);
  }
  ...
  public LocationCreationTO withProperty(@Nonnull String key, @Nonnull String value) {
    return new LocationCreationTO(getName(), propertiesWith(key, value), typeName, position, links, Bins);
  }
}
