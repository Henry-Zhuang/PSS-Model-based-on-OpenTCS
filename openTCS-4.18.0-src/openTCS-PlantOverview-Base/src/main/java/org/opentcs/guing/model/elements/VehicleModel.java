...
public class VehicleModel
  ...
  public static final String BINSKU = "BinSKU";
  ...
  ////////////////////////////////////////////////modified by Henry
  public StringProperty getPropertyBinID() {
    return (StringProperty) getProperty(BINID);
  }
  public StringProperty getPropertyBinSKU() {
    return (StringProperty) getProperty(BINSKU);
  }
  public StringProperty getPropertyType() {
    return (StringProperty) getProperty(TYPE);
  } 
  ////////////////////////////////////////////////modified end
  ...
  private void createProperties() {
    ...
    ////////////////////////////////////////////////////////modified by Henry
    StringProperty pBinID = new StringProperty(this);
    pBinID.setDescription(bundle.getString("vehicleModel.property_binID.description"));
    pBinID.setHelptext(bundle.getString("vehicleModel.property_binID.helptext"));
    setProperty(BINID, pBinID);
    
    StringProperty pBinSKU = new StringProperty(this);
    pBinSKU.setDescription(bundle.getString("vehicleModel.property_SKU.description"));
    pBinSKU.setHelptext(bundle.getString("vehicleModel.property_SKU.helptext"));
    setProperty(BINSKU, pBinSKU);
    
    StringProperty pType = new StringProperty(this);
    pType.setDescription(bundle.getString("vehicleModel.property_type.description"));
    pType.setHelptext(bundle.getString("vehicleModel.property_type.helptext"));
