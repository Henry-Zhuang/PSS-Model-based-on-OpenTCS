...
public class Vehicle
  ...
  ////////////////////////////////////////////// modified by Henry
  /**
   * The type of the change-track vehicle.
   */
  public static final String TRACK_VEHICLE_TYPE = "PST";
  
  public static final String BIN_VEHICLE_TYPE = "PSB";
  ////////////////////////////////////////////// modified end
  /**
...
/////////////////////////////////////////////////////modified by Henry
  /**
   * Returns this vehicle's current bin.
   * 
   * @return This vehicle's current bin.
   */
  public Bin getBin() {
    return bin;
  }
  /**
   * Creates a copy of this object, with the given bin.
   *
   * @param bin The given bin.
   * @return A copy of this object, differing in the given value.
   */
  public Vehicle withBin(Bin bin) {
    return new Vehicle(getIdWithoutDeprecationWarning(),
                       getName(),
                       getProperties(),
                       getHistory(),
