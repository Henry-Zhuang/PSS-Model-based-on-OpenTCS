...
public interface VehicleController
   ...
   * commands.
   * @param opDestinations A sequence of destinations corresponding to <code>operations</code>
   ...
   */
  @Nonnull
  ExplainedBoolean canProcess(@Nonnull List<String> operations, @Nonnull List<TCSObjectReference<?>> opDestinations);//modified by Henry
  ...
  //////////////////// created by Henry
  default void setBinVehicleInPlace(){}
  default void setTrackVehicleInPlace(){}
  //////////////////// created end
}
