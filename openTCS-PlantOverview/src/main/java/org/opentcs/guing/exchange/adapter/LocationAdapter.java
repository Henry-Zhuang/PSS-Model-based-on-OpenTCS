...
public class LocationAdapter
  ...
  public void updateModelProperties(TCSObject<?> tcsObject,
    ...
    try {
      ...
      model.getPropertyModelPositionY().setValueAndUnit(location.getPosition().getY(),
                                                        LengthProperty.Unit.MM);
      //modified by Henry
      model.getPropertyModelPositionZ().setValueAndUnit(location.getPosition().getZ(),
                                                        LengthProperty.Unit.MM);
    ...
    PlantModelCreationTO result = plantModel
        .withLocation(
            new LocationCreationTO(modelComponent.getName(),
                ...
                .withBins(Bins)//modified by Henry
        )
  ...
  private Triple convertToTriple(CoordinateProperty cpx, CoordinateProperty cpy, CoordinateProperty cpz) {
