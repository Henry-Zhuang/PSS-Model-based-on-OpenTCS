...
public abstract class CoordinateUndoActivity
  ...
  //modified by Henry
  protected final CoordinateProperty pzModel;
  ...
  private CoordinateProperty pzBeforeModification;
  private CoordinateProperty pxAfterModification;
  private CoordinateProperty pyAfterModification;
  private CoordinateProperty pzAfterModification;
  ...
  public CoordinateUndoActivity(@Assisted CoordinateProperty property,
    ...
    pzModel = (CoordinateProperty) model.getProperty(PositionableModelComponent.MODEL_Z_POSITION);
  ...
  public void snapShotBeforeModification() {
    ...
    pzBeforeModification = (CoordinateProperty) pzModel.clone();
  ...
  public void snapShotAfterModification() {
    ...
    pzAfterModification = (CoordinateProperty) pzModel.clone();
  }
  ...
  public void undo()
    ...
    pzModel.copyFrom(pzBeforeModification);
    pxModel.markChanged();
    pyModel.markChanged();
    pzModel.markChanged();
  ...
  public void redo()
    ...
    pzModel.copyFrom(pzAfterModification);
    pxModel.markChanged();
    pyModel.markChanged();
    pzModel.markChanged();
